        ...
        <div className="pvcontainer" id="video_section">
            ...
            <div className="videos_section1">
                <div className="video1">
                    <video width="300" height="500" controls playsInline onContextMenu="return false;" preload="metadata" autoplay>
                ...
                <div className="video2">
                    <video title="vimeo-player" width="300" height="500" controls playsInline onContextMenu="return false;" preload="metadata" autoplay>
